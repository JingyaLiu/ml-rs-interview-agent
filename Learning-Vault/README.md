# Learning-Vault (template)

Markdown memory for the interview agent. Fill locally; keep personal data out of public forks.
...
See also [docs/HOW_TO_USE.md](../docs/HOW_TO_USE.md) and [docs/PRIVACY.md](../docs/PRIVACY.md).
